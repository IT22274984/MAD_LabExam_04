...
import com.example.todo_main.util.FireStoreCollection
import com.example.todo_main.util.SharedPrefConstants
import com.example.todo_main.util.UiState
import javax.inject.Inject

class AuthRepositoryImplementation<Gson> @Inject constructor(
...
private fun <Gson> Gson.fromJson(userSession: String, java: Class<User>): User? {
